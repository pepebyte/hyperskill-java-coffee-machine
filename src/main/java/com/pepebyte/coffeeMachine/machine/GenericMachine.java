package com.pepebyte.coffeeMachine.machine;

import com.pepebyte.coffeeMachine.Ingredient;
import com.pepebyte.coffeeMachine.Product;
...
public class GenericMachine implements Machine{
    ...
    @Override
    public void buy() {
        consumer("What do you want buy? " + list() + ", back - to main menu: ");
